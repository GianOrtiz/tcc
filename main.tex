...
\titulo{\lang{Work Title\protect\\Could be break into two lines}{Implementação de algoritmo de Checkpoint para arquitetura de Checkpoint/Restore de Stateful Containers no Kubernetes}}
...
\coordenador[\lang{Coordinator}{Coordenador}]{\brazilword{Renato Cislaghi}, \lang{Phd.}{Dr.}}
...
\palavraschaveufsc{palavraschaveingles}   {Container}
\palavraschaveufsc{palavraschaveportugues}{Conteiner}
...
\palavraschaveufsc{palavraschaveingles}   {Fault tolerancy}
