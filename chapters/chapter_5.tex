...
\begin{tabular}{|c|c|c|}
\hline
\textbf{\begin{tabular}[c]{@{}c@{}}Ńúmero de requisições\\ acumuladas\end{tabular}} & \textbf{\begin{tabular}[c]{@{}c@{}}Tempo de detecção \\ (microssegundos) \end{tabular}} &
\textbf{\begin{tabular}[c]{@{}c@{}}Tempo de Recuperação \\ (segundos) \end{tabular}} \\ \hline
1000(A) &  991011 & 0.990702s \\ \hline
10000(B) & 998153 & 0.975395s     \\ \hline
20000(C) & 1013021 & 856.67s \\ \hline
\end{tabular}
\end{table}
