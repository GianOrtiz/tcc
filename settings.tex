...
\hyphenation{co-mu-ni-ca-ção}
\hyphenation{e-la-bo-ra-ção}
\hyphenation{ver-si-o-na-men-to}
\hyphenation{pos-sí-vel}
\hyphenation{ex-pe-ri-men-tos}
\hyphenation{in-dis-po-ni-bi-li-da-de}
\hyphenation{uma}
\hyphenation{ins-pi-ra-da}
\hyphenation{vo-lu-me}
\hyphenation{Ad-mi-nis-tra-dor}
\hyphenation{mo-ni-to-ra-da}
